      ...
      <div class="login-box">
        <form class="login-form" id="login" action="<?php echo base_url('login/do_login'); ?>" method="post">
          ...
          <div class="form-group">
            <div class="utility">
              <p class="semibold-text mb-0"><a data-toggle="flip">Olvidé mi Contraseña?</a></p>
            </div>
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" id="btn-login">INGRESAR<i class="fa fa-sign-in fa-lg"></i></button>
          </div>
        </form>
        <form class="forget-form" method="post" action="<?php echo base_url().'login/forget_password/do_reset' ?>">
          ...
          <div class="form-group mt-20">
            <p class="semibold-text mb-0"><a data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> Volver al Login</a></p>
          </div>
        </form>
      </div>
    </section>
