...
(NULL, 'offline_payment_title', 'Offline Payment'),
(NULL, 'offline_payment_instruction', 'Offline payment instruction goes here.'),
(NULL, 'reword_ad', 'disable'),
(NULL, 'reword_ad_id', 'xxxxxxxxxx'),
(NULL, 'banner_ad', 'disable'),
(NULL, 'banner_ad_id', 'xxxxxxxxxx'),
(NULL, 'interstitial_ad', 'disable'),
(NULL, 'interstitial_ad_id', 'xxxxxxxxxx'),
(NULL, 'interstitial_ad_interval', '5'),
(NULL, 'native_ad', 'disable'),
(NULL, 'native_ad_id', 'xxxxxxxxxx'),
(NULL, 'native_ad_interval', '5'),
(NULL, 'reward_ad', 'disable'),
(NULL, 'reward_ad_id', 'xxxxxxxxxx'),
(NULL, 'unity_android_game_id', 'xxxxxxxxxxx'),
(NULL, 'unity_ios_game_id', 'xxxxxxxxxxx'),
